...
Route::group(['prefix' => 'foodie'], function () {
    ...
    Route::get('plans/simpleView/{simpleCustomPlan}, Foodie\FoodieMealPlanController@simpleCustomizeView')->name('foodie.plan.simpleView');
    ...
    Route::post('chefs/customize/simple/{plan}','Foodie\FoodieMealPlanController@simpleMake')->name('foodie.simple.custom');
