                ...
                <div class="col s12 m2">
                    ...
                    <div>
                        <ul class="collection">
                            ...
                            <li class="collection-item"><div>Pending Delivery:</div> <span style="font-size: 14px;">{{$orderItems->where('is_delivered','=',0)->where('order_items.is_cancelled','=',0)->count()}} orders</span></li>
                    ...
                    <div class="row">
                        ...
                        <div class="row">
                            <div class="col s12 m3">
                                ...
                                {{--<select id="monthFilter"></select>--}}
                                {{--<select id="dayFilter"></select>--}}
                                <input type="text" id="dateDeliverFilter" placeholder="Please choose a day">
