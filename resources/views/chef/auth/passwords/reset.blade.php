...
@section('head')
    <title>Reset Password - Diet Select PH | Making the world a healthier place with one meal plan at a time!</title>
...
<div class="valign-wrapper" style="position: absolute; height: 100%; width: 100%;">
    ...
    <div id="reset-password" class="card valign">
        <form id="reset-password" role="form" method="POST" action="{{ route('chef.reset') }}">
            {{ csrf_field() }}
            ...
            <div class="card-content">
                ...
                <div class="row">
                    <div class="input-field col s12">
                        <input id="n-reset-email" name="email" type="email" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,63}$" data-error=".error-msg-email" value="{{ old('email') }}"/>
