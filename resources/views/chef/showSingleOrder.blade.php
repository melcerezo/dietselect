...
@section('page_content')
    ...
    @else
        ...
        <div class="row">
            <div class="col s12 m6 left plSlMlBtn" style="padding-left:0;">
                {{--<button id="fnshEdt" data-target="finishEdit" class="btn waves-effect waves-light modal-trigger">Back</button>--}}
            </div>
            <div class="col s12 m6 right plSlMlInfCnt" style="padding-right:0;">
                <div class="plSlMlInfDef card-panel" style="padding: 0;">
                    <ul class="collection">
