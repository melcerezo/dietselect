                                    ...
                                    <div class="card sticky-action hoverable">
                                        <div class="card-image waves-effect waves-block waves-asparagus">
                                            <a href="#createPlan" class="modal-trigger">
                                                <span class="fa fa-plus-circle light-green-text"
                                                      style="display: block; font-size: 8em; margin: 0.15em auto; width: 100%; text-align: center;"></span>
                                            </a>
                                        </div>
                                        <div class="card-content no-pad-top">
                                            <h2 class="card-title activator grey-text center text-darken-4 no-pad-bot">
                                                Add New Meal Plan</h2>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <div class="col s12 m6 l4">
                                            <div class="card sticky-action hoverable">
                                                ...
                                                <div class="card-reveal center lime lighten-4">
                                                    ...
                                                    <a class="meal-plan-option-btn"
                                                       href="{{ route('chef.plan.table',['plan'=>$plan->id]) }}"><span
                                                                class="fa fa-pencil"></span></a>
                                                    <a class="meal-plan-option-btn modal-trigger"
                                                       href="#deletePlan"><span class="fa fa-trash"></span></a>
                                                </div>
                                            </div>
                                            <div id="deletePlan" class="modal">
                                                ...
                                                <div class="modal-content">
                                                    <form id="deletePlanForm"
                                                          action="{{route('chef.plan.delete',['plan'=>$plan->id])}}"
                                                          method="post">
                                                        {{csrf_field()}}
                                                        <div>
                ...
                <div class="modal-content">
                    ...
                    <div class="row">
                        <div class="input-field">
                            ...
                            <input type="text" name="plan_name" id="plan_name" data-error=".error-plan-name"
                                   class="form-control">
                    ...
                    <div class="row">
                        <div class="input-field">
                            ...
                            <input type="text" name="calories" id="calories" data-error=".error-calories"
                                   class="form-control">
