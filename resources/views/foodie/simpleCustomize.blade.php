                        ...
                        <div class="mlCnt">
                            @foreach($simpleCustomMeals as $id =>$simpleCustomMeal)
                                @if($simpleCustomMeal->chef_customized_meal->mealplans->day == 'MO' && $simpleCustomMeal->chef_customized_meal->mealplans->meal_type == 'Breakfast')
                                    <a data-meal-active="#viewMeal-{{$id}}" href="#editMeal-{{$id}}" data-id="{{$simpleCustomMeal->chef_customized_meal->id}}" data-form-id="{{$id}}"
            ...
            <div class="col s12 m3 custAction">
                <div>
                    ...
                    <div>
                        ...
                        @else
                            <button type="button" data-target="orderReview" class="btn disabled" style="margin:0 10px 10px 0;">Cart</button>
                        @endif
                    </div>
                    <div class="divider">
                    </div>
    ...
    @if($simpleCustomPlan->simple_custom_plan_detail->count())
        <div id="detailCust" class="modal">
           ...
           <div class="modal-content">
               @if($tasteCount>0)
                   <ul class="collection">
                       <li class="collection-item" style="font-size: 20px;">
