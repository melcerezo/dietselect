...
//        dd($chats->count());
        ...
        $pendingOrderItems = OrderItem::where('chef_id','=',$chef->id)->orderBy('created_at','desc')->where('is_delivered','=',0)->take(5)->get();
...
//        dd($pendingOrderItems);
        ...
        foreach($pendingOrderItems as $orderItem){
            ...
            }else if($orderItem->order->is_paid == 1 && $orderItem->order->is_cancelled==0 && $orderItem->is_delivered==0){
