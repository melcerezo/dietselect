...
//        $meal->ingredients()->sync(array([$request['ingredients'], false, $request['day'], $request['meal_type']]));
//        DB::table('ingredient_meal')->insert(['meal_id' => $request['day'], 'meal_type' => $request['meal_type']]);
        return back();
